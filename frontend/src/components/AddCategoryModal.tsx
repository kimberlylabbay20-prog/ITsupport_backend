...
interface AddCategoryModalProps {
  ...
  onCreated: (category: { category_id: number; name: string; description: string | null; created_at: string }) => void;
}
...
export default function AddCategoryModal({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      notify("error", getErrorMessage(e, "Failed to create category."));
      setSaving(false);
    }
  };
