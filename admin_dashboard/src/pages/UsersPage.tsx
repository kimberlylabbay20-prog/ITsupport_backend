...
export default function UsersPage() {
  ...
  const loadUsers = (showLoader = true) => {
  ...
  const filtered = useMemo(() => {
    ...
    const roleText = { admin: "admin", staff: "staff", user: "user" };
    return users
      .filter((u) => {
        if (!q) return true;
        return (
          ...
          (roleText[u.role] ?? u.role).includes(q)
        );
      })
  ...
  const isSelf = (user: User) => currentUser?.user_id === user.user_id;
    ...
    <Layout>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2 text-[12px] text-text-muted">
          ...
          <span className="text-text-dark font-medium">All Users</span>
        </div>
      </div>
      ...
      <div className="mb-4 flex items-center gap-3">
        <div className="relative w-full max-w-sm">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg text-[13px] text-text-dark focus:outline-none focus:ring-2 focus:ring-primary-200 focus:border-primary-300"
          />
        </div>
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-[13px] text-text-muted mt-1">
              {search
                ...
                : "Users created through the system will appear here."}
            </p>
          </div>
        ) : (
          <table className="w-full">
                ...
                >
                  ...
                  <td className="px-4 py-3.5">
                    <div className="flex items-center gap-3">
                      ...
                      {isSelf(member) && (
                        <span className="inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-semibold bg-primary-50 text-primary-600">
                          You
                        </span>
                      )}
                    </div>
                  ...
                  <td className="px-4 py-3.5 text-right whitespace-nowrap">
                    <div className="flex items-center justify-end gap-1.5">
                      ...
                      <button
                        ...
                        disabled={togglingId !== null || isSelf(member)}
                        title={
                          isSelf(member)
